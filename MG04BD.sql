DROP DATABASE IF EXISTS MG04BD;
CREATE DATABASE MG04BD;
USE MG04BD;
...
INSERT INTO Partida VALUES (1, '11-03-2021 09:00', 19, 'Alba');
INSERT INTO Partida VALUES (2, '11-03-2021 09:30', 26, 'Angelica');
INSERT INTO Partida VALUES (3, '11-03-2021 10:00', 12, 'Irene');
...
SELECT COUNT(Juego.ID_P) FROM Jugador,Juego WHERE
    ...
    Jugador.ID = Juego.ID_J AND
    Jugador.ID IN (SELECT Juego.ID_P FROM Jugador,Juego 
