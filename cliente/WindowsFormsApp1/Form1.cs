...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void EscribirDatachat(string chat)
        {
            //string[] Subtrozos = message.Split('/');
            //int idpartida = Convert.ToInt32(Subtrozos[1]);
            dataGridchat.ColumnCount = 1;
            //dataGridchat.Rows.Add(Subtrozos[2]);
            dataGridchat.Rows.Add(chat);
        }

        private void ActualizaGrid(string[] trozos)
        {
            //string[] Subtrozos = trozos.Split('/');
            ...
            while (true)
            {
                ...
                switch (codigo) //todos lo que resibimos esta en el thread 
                {
                    ...
                    case 11:
                        ...
                        dataGridchat.Invoke(new DelegadoParaEscribirAlChat(EscribirDatachat), new object[] { chat });
                        break;
        ...
        //enviamos un mensaje al chat de la partida
        private void button7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string mensaje = "11/" + "0/" + textChat.Text;
                    byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                    server.Send(msg);
                }
